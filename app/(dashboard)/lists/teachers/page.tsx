...
const renderRow = (item:TeacherList) =>
    (
        ...
        <Image src={item.img ||"/noAvatar.png"} alt=" " 
        width={40} height={40}
        ...
        <Link href={ `/lists/teacher/${item.id}`}>
        <button className="w-7 h-7 flex items-center justify-center rounded-full bg-blue-100">
        <Image src="/view.png" alt="" width={16} height={16}/>
        </button>
        </Link>
        {role === "admin" && (//<button className="w-7 h-7 flex items-center justify-center rounded-full bg-purple-200">
...
}) =>
 {
   ...
   prisma.teacher.count({where:query})
    ...
    return(
        ...
        {role ==="admin" && //(<button className="w-8 h-8 rounded-full bg-yellow-400 flex items-center justify-center">
